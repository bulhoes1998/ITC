...
/* package ITC-0.1.0.0 */
#ifndef VERSION_ITC
#define VERSION_ITC "0.1.0.0"
#endif /* VERSION_ITC */
#ifndef MIN_VERSION_ITC
#define MIN_VERSION_ITC(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_ITC */
...
#define CURRENT_COMPONENT_ID "ITC-0.1.0.0-IEseJdLdu4Q4YippIEGZy4-ITC"
